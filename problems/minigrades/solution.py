"""
mini-grades v1 - advanced implementation
...
add-student, add-grade, delete-student, delete-grade, calculate-average, list-students functions are now working.
generate-report and change-grade will be implemented soon.
"""
